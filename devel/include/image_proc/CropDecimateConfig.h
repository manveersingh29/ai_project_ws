...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CropDecimateConfig::AbstractParamDescriptionConstPtr(new CropDecimateConfig::ParamDescription<int>("interpolation", "int", 0, "Sampling algorithm", "{'enum': [{'name': 'NN', 'type': 'int', 'value': 0, 'srcline': 21, 'srcfile': '/home/manveer/ai_project_ws/src/image_pipeline/image_proc/cfg/CropDecimate.cfg', 'description': 'Nearest-neighbor sampling', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Linear', 'type': 'int', 'value': 1, 'srcline': 22, 'srcfile': '/home/manveer/ai_project_ws/src/image_pipeline/image_proc/cfg/CropDecimate.cfg', 'description': 'Bilinear interpolation', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Cubic', 'type': 'int', 'value': 2, 'srcline': 23, 'srcfile': '/home/manveer/ai_project_ws/src/image_pipeline/image_proc/cfg/CropDecimate.cfg', 'description': 'Bicubic interpolation over 4x4 neighborhood', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Area', 'type': 'int', 'value': 3, 'srcline': 24, 'srcfile': '/home/manveer/ai_project_ws/src/image_pipeline/image_proc/cfg/CropDecimate.cfg', 'description': 'Resampling using pixel area relation', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Lanczos4', 'type': 'int', 'value': 4, 'srcline': 25, 'srcfile': '/home/manveer/ai_project_ws/src/image_pipeline/image_proc/cfg/CropDecimate.cfg', 'description': 'Lanczos interpolation over 8x8 neighborhood', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'interpolation type'}", &CropDecimateConfig::interpolation)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 21 "/home/manveer/ai_project_ws/src/image_pipeline/image_proc/cfg/CropDecimate.cfg"
      const int CropDecimate_NN = 0;
//#line 22 "/home/manveer/ai_project_ws/src/image_pipeline/image_proc/cfg/CropDecimate.cfg"
      const int CropDecimate_Linear = 1;
//#line 23 "/home/manveer/ai_project_ws/src/image_pipeline/image_proc/cfg/CropDecimate.cfg"
      const int CropDecimate_Cubic = 2;
//#line 24 "/home/manveer/ai_project_ws/src/image_pipeline/image_proc/cfg/CropDecimate.cfg"
      const int CropDecimate_Area = 3;
//#line 25 "/home/manveer/ai_project_ws/src/image_pipeline/image_proc/cfg/CropDecimate.cfg"
