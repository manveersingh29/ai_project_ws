...
echo_and_run cd "/home/manveer/ai_project_ws/src/image_pipeline/camera_calibration"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/manveer/ai_project_ws/build/image_pipeline/camera_calibration \
    build --build-base "/home/manveer/ai_project_ws/build/image_pipeline/camera_calibration" \
    install \
    --root="${DESTDIR-/}" \
